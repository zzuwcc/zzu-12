...
class detect:
    def __init__(self, name):
        ...
        self.button_a = tk.Button(self.window, text='开始刷脸', font=('Arial', 12), width=10, height=2,
                                  command=self.f_scan_face)
        self.button_a.place(x=800, y=120)

        self.button_b = tk.Button(self.window, text='录入人脸', font=('Arial', 12), width=10, height=2,
                                  command=self.f_rec_face)
